# ------------------------------------------------------------------------------------------------
# armour.tcl v3.4.3 autobuild completed on: Thu Jan 16 07:54:41 PST 2020
# ------------------------------------------------------------------------------------------------
#
#    _                         ___ ___ 
...
proc arm:cmd:help {0 1 2 3 {4 ""}  {5 ""}} {
	...
	if {$command == "help"} { arm:reply $type $target "\002usage:\002 help \[command\]"; return; }
	...
	if {$command == "" || $command == "cmds" || $command == "commands"} {
		...
		if {$cmdlist == ""} { arm:reply $type $target "error: no access to commands."; return; }
		# -- send the command list
		arm:reply $type $target "commands: [join [lsort -dictionary $cmdlist]]"
...
proc arm:cmd:kick {0 1 2 3 {4 ""}  {5 ""}} {
	...
	if {$kicklist == ""} { arm:reply $type $target "\002usage:\002 kick ?chan? <nick1,nick2,nick3...> \[reason\]"; return; }
...
proc arm:cmd:ban {0 1 2 3 {4 ""}  {5 ""}} {
	...
	if {$banlist == ""} { arm:reply $type $target "\002usage:\002 ban ?chan? <nick1,mask1,nick2,mask2,mask3...> \[duration\] \[reason\]"; return; }
...
proc arm:cmd:unban {0 1 2 3 {4 ""}  {5 ""}} {
	...
	if {$unbanlist == ""} { arm:reply $type $target "\002usage:\002 unban ?chan? <nick1,nick2,mask1...>"; return; }
...
proc arm:cmd:topic {0 1 2 3 {4 ""}  {5 ""}} {
	...
	if {$topic == ""} { arm:reply $type $target "topic: ?chan? <topic>"; return; }
...
proc arm:cmd:black {0 1 2 3 {4 ""}  {5 ""}} {
	...
	if {$tnick == ""} { arm:reply $type $target "\002usage:\002 black <nick> \[reason\]"; return; }
...
proc arm:cmd:asn {0 1 2 3 {4 ""}  {5 ""}} {
	...
	if {$ip == ""} { arm:reply $type $target "\002usage:\002 asn <ip>"; return; }
...
proc arm:cmd:chanscan {0 1 2 3 {4 ""}  {5 ""}} {
	...
	#if {$chan == ""} { arm:reply $type $target "\002usage:\002 chanscan <chan>"; return; }
...
proc arm:cmd:mode {0 1 2 3 {4 ""}  {5 ""}} {
	...
	if {$mode != "on" && $mode != "off" && $mode != "secure" && $mode != ""} { arm:reply $type $target "\002usage:\002 mode <on|off|secure>"; return; }
...
proc arm:cmd:country {0 1 2 3 {4 ""}  {5 ""}} {
	...
	set ip [lindex $args 0]
	if {$ip == ""} { arm:reply $type $target "\002usage:\002 country <ip>"; return; }
...
proc arm:cmd:scanrbl {0 1 2 3 {4 ""}  {5 ""}} {
	...
	if {$host == ""} { arm:reply $type $target "\002usage:\002 scanrbl <host|ip>"; return; }
...
proc arm:cmd:scanports {0 1 2 3 {4 ""}  {5 ""}} {
	...
	if {$host == ""} { arm:reply $type $target "\002usage:\002 scanports <host|ip> \[port1,port2,port3...\]"; return; }
...
proc arm:cmd:exempt {0 1 2 3 {4 ""}  {5 ""}} {
	...
	if {$exempt == ""} { arm:reply $type $target "\002usage:\002 exempt <nick> \[mins\]"; return; }
...
proc arm:cmd:scan {0 1 2 3 {4 ""}  {5 ""}} {
	...
	if {$search == ""} { arm:reply $type $target "\002usage:\002 scan <value>"; return; }
...
proc arm:cmd:search {0 1 2 3 {4 ""}  {5 ""}} {
	...
	if {$list == "" || $search == ""} { arm:reply $type $target "\002usage:\002 search <white|black|*> <search>"; return; }
	...
	if {$list == "white" || $list == "*"} {
		...
		# -- invalid list type
		arm:reply $type $target "\002usage:\002 search <white|black|*> <wildcard>"
		return;
	}
...
proc arm:cmd:die {0 1 2 3 {4 ""}  {5 ""}} {
	...
	if {[string tolower $safety] != "-force"} { arm:reply $type $target "seriously? use: die -force <reason>"; return; }
	set reason [lrange $args 1 end]
	if {$reason == ""} { set reason "requested by $nick!$uh ([userdb:uline:get user nick $nick])" }
...
proc arm:cmd:say {0 1 2 3 {4 ""}  {5 ""}} {
	...
	if {$dest == "" || $string ==""} { arm:reply $type $target "\002usage:\002 say \[-a\] <chan|*|nick> <string>"; return;  }
	...
	if {$dest == "-a"} {
		...
		if {$string == ""} { arm:reply $type $target "\002usage:\002 say \[-a\] <chan|*|nick> <string>"; return;  }
	}
...
proc arm:cmd:view {0 1 2 3 {4 ""}  {5 ""}} {
	...
	elseif {[string index $list 0] == "d"} { set list "dronebl" } \
		...
		if {[info command ::dronebl::submit] == "" || [userdb:uline:get level nick $nick] < $arm(cfg.dronebl.lvl)} {
			...
			arm:reply $type $target "\002usage:\002 view <white|black|id> ?<user|host|rname|regex|country|asn|chan> <value1,value2..>?";
		} else {
			# -- libdronebl loaded & user has sufficient access
			arm:reply $type $target "\002usage:\002 view <white|black|dronebl|id> ?<user|host|rname|regex|country|asn|chan> <value1,value2..>?";
		}
		return;
	}
	...
	if {$list == "dronebl"} {
		...
		if {[info command ::dronebl::submit] == "" || [userdb:uline:get level nick $nick] < $arm(cfg.dronebl.lvl)} {
			...
			if {$value == "" || $method == ""} {
				arm:reply $type $target "\002usage:\002 view dronebl <host|ip> <value1,value2..>"
				return;				
			}
...
proc arm:cmd:add {0 1 2 3 {4 ""}  {5 ""}} {
	...
	switch -- $method {
		...
		default {
			if {[info command ::dronebl::submit] == "" || [userdb:uline:get level nick $nick] < $arm(cfg.dronebl.lvl)} {
				...
				arm:reply $type $target "\002usage:\002 add <white|black> <user|host|rname|regex|country|asn|chan|last> <value1,value2..> <accept|voice|op|ban> ?joins:secs:hold? \[reason\]"
			} else {
				# -- libdronebl loaded & user has access to dronebl submit
				arm:reply $type $target "\002usage:\002 add <white|black|dronebl> <user|host|rname|regex|country|asn|chan|last> <value1,value2..> <accept|voice|op|ban> ?joins:secs:hold? \[reason\]"		
			}
			return;
		}
	}
	...
	if {$list == "dronebl"} {
		...
		if {[info command ::dronebl::submit] == "" || [userdb:uline:get level nick $nick] < $arm(cfg.dronebl.lvl)} {
			...
			if {$value == "" || $method == ""} {
				arm:reply $type $target "\002usage:\002 add dronebl <host|ip|last> <value1,value2..> \[type\]"
				return;				
			}
...
proc arm:cmd:rem {0 1 2 3 {4 ""}  {5 ""}} {
	...
	if {$list == ""} {
		if {[info command ::dronebl::submit] == "" || [userdb:uline:get level nick $nick] < $arm(cfg.dronebl.lvl)} {
			...
			arm:reply $type $target "\002usage:\002 rem <white|black|id> ?<user|host|rname|regex|country|asn|chan> <value1,value2..>?"
		} else {
			# -- libdronebl loaded & user has submit access
			arm:reply $type $target "\002usage:\002 rem <white|black|dronebl|id> ?<user|host|rname|regex|country|asn|chan> <value1,value2..>? \[type\]"
		}
		return;
	}
	...
	if {$list == "dronebl"} {
		...
		if {[info command ::dronebl::submit] == "" || [userdb:uline:get level nick $nick] < $arm(cfg.dronebl.lvl)} {
			...
			if {$value == "" || $method == ""} {
				arm:reply $type $target "\002usage:\002 rem dronebl <host|ip> <value1,value2..> \[type\]"
				return;				
			}
